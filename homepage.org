#+hugo_base_dir: /home/joey/homepage/
...
with [[https://www.inf.ed.ac.uk/people/staff/Ohad_Kammar.html][Ohad Kammar]] in the [[https://web.inf.ed.ac.uk/lfcs][Laboratory for Foundations of Computer Science]]
...
** Passed Doctoral Defence
:PROPERTIES:
:EXPORT_DATE: <2023-03-06>
:EXPORT_FILE_NAME: defence-passed1
:END:
On March 6, 2023 I successfully defended my dissertation "On The Design of a Gradual Dependently Typed Language for Programming".
The final dissertation will be available soon, pending minor revisions suggested by the examining committee.
...
:END:
The final version of my dissertation can be read [[https://dx.doi.org/10.14288/1.0428823][here]].
